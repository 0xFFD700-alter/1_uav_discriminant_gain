...
power_tx = 0.02  # transmit power, P_{k}
...
#     svm_accuracy_list[i], mlp_accuracy_list[i] = FC(power_tx,num_device,PCA_dim)
#
...
# PCA_dim_list = np.linspace(2, 22, 11)
...
#     PCA_dim = int(PCA_dim_list[i])
#     svm_accuracy_list[i], mlp_accuracy_list[i], noise, data, data_after  = FC(power_tx, num_device, PCA_dim)
#
